...
@UseCase
class EstimateIssueUseCase(
    private val boardRepository: BoardRepository,
    private val findIssueLeadTimes: FindIssueLeadTimesUseCase,
    private val issueClient: IssueClient,
    private val parseEstimateIssue: ParseEstimateIssueUseCase,
    private val createOpenedIssueJql: CreateOpenedIssueJqlUseCase,
    ...
    fun execute(
        ...
        val estimateIssues: List<EstimatedIssue> = searcher.search(jql, board, holidays)
