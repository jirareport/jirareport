...
@Tag("unit")
internal class WipServiceImplTest {

    private val wipServiceImpl: WipServiceImpl = WipServiceImpl()
    ...
    fun `test calc avg wip`() {
        ...
        val wipAvg = wipServiceImpl.calcAvgWip(startDate, endDate, issues, fluxColumn.wipColumns)
