...
import br.com.jiratorio.mapper.DynamicFieldConfigMapper
...
class DynamicFieldConfigServiceImpl(
    ...
    private val dynamicFieldConfigMapper: DynamicFieldConfigMapper,
    ...
    override fun create(boardId: Long, dynamicFieldConfigRequest: DynamicFieldConfigRequest): Long {
        ...
        val board = boardService.findById(boardId)
        val dynamicFieldConfig = dynamicFieldConfigMapper.dynamicFieldConfigRequestToDynamicFieldConfig(
            board,
            dynamicFieldConfigRequest
        )
