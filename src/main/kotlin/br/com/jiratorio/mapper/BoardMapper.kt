...
fun BoardEntity.updateFromUpdateBoardRequest(updateBoardRequest: UpdateBoardRequest) {
    ...
    fluxColumn = updateBoardRequest.fluxColumn?.toUpperCase()?.toMutableList() ?: mutableListOf()
    ignoreIssueType = updateBoardRequest.ignoreIssueType ?: mutableListOf()
    ...
    impedimentColumns = updateBoardRequest.impedimentColumns?.toUpperCase()?.toMutableList() ?: mutableListOf()
    touchingColumns = updateBoardRequest.touchingColumns?.toUpperCase()?.toMutableList() ?: mutableListOf()
    waitingColumns = updateBoardRequest.waitingColumns?.toUpperCase()?.toMutableList() ?: mutableListOf()
